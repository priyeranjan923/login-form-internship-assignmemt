...
// const Loginpage = () => {
//   return (
//     <div className="flex  lg:flex-row md:flex-row flex-col w-11/12   ">
//       <div className="relative  md:w-1/2 sm:w-screen lg:w-1/2 mt-[3rem] ml-4  ">
...
//         <div className="flex flex-col  absolute lg:top-[20rem] md:top-[20rem] ml-4 ">
//           <div className="flex flex-row  text-white-25 items-center gap-2 font-mono">
//             <h1 className="font-bold lg:text-2xl md:text-2xl sm:text-xs">100% Uptime</h1>
...
//           </div>
//         </div>
//         <div className="absolute flex justify-between w-[90%] top-[30rem] ml-4">
//         <div className="">
...
//       <div className="  w-1/2  mt-[7rem] sm:ml-[5rem] ">
